  <div id="pocetna-div">
      <?php
        ...
        $naziv = $_POST['keySearchUnos'];

        require 'conn.php';

        $upit1 = "select knjiga.id, knjiga.naziv_knjige, knjiga.izdavac, knjiga.cena, pisac.ime, pisac.prezime, biblioteka.naziv from knjiga join pisac on knjiga.pisac_id=pisac.id join biblioteka on knjiga.biblioteka_id=biblioteka.id where knjiga.naziv_knjige like '%" . $naziv . "%'";
        $rezultat = $connection->query($upit1);
